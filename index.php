...
<style>
    /*Media Queries*/
	@media (min-width:320px)  {  .mars{ margin:10px; }  .size{ object-fit: cover;width: 100%; }  /* smartphones, iPhone, portrait 480x320 phones */ }
	@media (min-width:481px)  {  .mars{ margin:10px; }  .size{ object-fit: cover;width: 100%; } /* portrait e-readers (Nook/Kindle), smaller tablets @ 600 or @ 640 wide. */ }
 	@media (min-width:641px)  {  .mars{ margin:10px; }  .size{ object-fit: cover;width: 100%; } /* portrait tablets, portrait iPad, landscape e-readers, landscape 800x480 or 854x480 phones */ }
